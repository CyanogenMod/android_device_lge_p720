...
-include vendor/lge/p720/BoardConfigVendor.mk

TARGET_NO_BOOTLOADER := true
TARGET_BOARD_PLATFORM := omap4
TARGET_CPU_ABI := armeabi-v7a
TARGET_CPU_ABI2 := armeabi
TARGET_BOOTLOADER_BOARD_NAME := p720
TARGET_CPU_SMP := true
...
TARGET_KERNEL_CONFIG := cyanogenmod_p720_defconfig
...
TARGET_BOOTLOADER_BOARD_NAME := p720
TARGET_OTA_ASSERT_DEVICE := p720,p725

BOARD_EGL_CFG := device/lge/p720/egl.cfg
...
TARGET_SPECIFIC_HEADER_PATH := device/lge/p720/include

BOARD_HAS_VIBRATOR_IMPLEMENTATION := ../../device/lge/p720/vibrator.c

COMMON_GLOBAL_CFLAGS += -DICS_AUDIO_BLOB -DICS_CAMERA_BLOB


KERNEL_SGX_MODULES:
	make -C device/lge/p720/sgx-module/eurasia_km/eurasiacon/build/linux2/omap4430_android/ O=$(KERNEL_OUT) KERNELDIR=$(ANDROID_BUILD_TOP)/$(KERNEL_SRC) ARCH="arm" $(ARM_CROSS_COMPILE) KERNEL_CROSS_COMPILE=$(ARM_CROSS_COMPILE) TARGET_PRODUCT="blaze_tablet" BUILD=release TARGET_SGX=540 PLATFORM_VERSION=4.0
