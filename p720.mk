...
$(call inherit-product-if-exists, vendor/lge/p720/p720-vendor.mk)

$(call inherit-product, device/common/gps/gps_eu.mk)

DEVICE_PACKAGE_OVERLAYS += device/lge/p720/overlay
...
## Scripts and confs
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/init.p720.usb.rc:root/init.p720.usb.rc \
    $(LOCAL_PATH)/init.lgep720board.rc:root/init.lgep720board.rc \
    $(LOCAL_PATH)/ueventd.lgep720board.rc:root/ueventd.lgep720board.rc \
    $(LOCAL_PATH)/vold.fstab:system/etc/vold.fstab \
    $(LOCAL_PATH)/configs/fstab.cx2:root/fstab.cx2 \
...
PRODUCT_NAME := full_p720
PRODUCT_DEVICE := p720
PRODUCT_MODEL := LG-P720
